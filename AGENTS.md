...
- Package Header v4 `boot.img` and sign it with an RSA-2048 AVB hash footer for the standard 64MB partition (`avbtool add_hash_footer --partition_name boot --partition_size $((64 * 1024 * 1024)) --algorithm SHA256_RSA2048`) matching the verified working 9f6f542 layout.
